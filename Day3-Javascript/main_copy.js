...
const langTexts = {
  aboutMe: [
    ...
    "Nuero-sama, AI สตรีมเมอร์ที่ฉลาดที่สุดในทุกยุคทุกสมัย ฉันเป็น The GOAT!"
  ],
  name: ["Nuero", "นิวโร"],
  school: ["Artificial Intelligence School", "โรงเรียนปัญญาประดิษฐ์"],
  program: ["Science and Mathematics", "วิทยาศาสตร์และคณิตศาสตร์"],
  hobby: ["Streaming, Play game, Singing", "สตรีมมิ่ง, เล่นเกม, ร้องเพลง"]
